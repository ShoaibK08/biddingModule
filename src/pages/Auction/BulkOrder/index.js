    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: "0 0 50px", padding: "12px" }}>
          <input
            type="checkbox"
            checked={values.selectTransporter.length > 0}
            onChange={(e) => {
              if (!e.target.checked) {
                setValues(prev => ({ ...prev, selectTransporter: [] }));
              }
            }}
            style={{
              width: "16px",
            ...
            <div style={{ flex: "0 0 50px", padding: "12px" }}>
              <input
                ...
                onChange={() => {
                  setValues(prev => ({
                    ...prev,
                    selectTransporter: prev.selectTransporter.filter(t => t.id !== transporter.id)
                  }));
                }}
                style={{
                  width: "16px",
      ...
      <div style={{
        ...
        <div style={{ fontSize: "14px", color: "#6c757d" }}>
          Total Selected: {[...new Map(values.selectTransporter.map(item => [item.id, item])).values()].length}
        </div>
        <button
          onClick={() => setShowTransporterModal(false)}
          style={{
